...
// src/models/SurveyResultWinnerModel.ts
var SurveyResultWinnerModel_exports = {};
__export(SurveyResultWinnerModel_exports, {
  default: () => SurveyResultWinnerModel_default
});
module.exports = __toCommonJS(SurveyResultWinnerModel_exports);
...
// src/models/SurveyResultWinnerModel.ts
var SurveyResultWinnerModel = class extends import_sequelize5.Model {
};
SurveyResultWinnerModel.init(
  {
    id: {
      type: import_sequelize5.DataTypes.UUID,
      defaultValue: import_sequelize5.DataTypes.UUIDV4,
      primaryKey: true,
      allowNull: false
    },
    surveyId: {
...
SurveyModel_default.hasOne(SurveyResultWinnerModel, {
  foreignKey: "winnerSurveyOptionId",
  as: "survey",
  onDelete: "CASCADE"
});
SurveyResultWinnerModel.belongsTo(SurveyOptionModel_default, {
  foreignKey: "winnerSurveyOptionId",
  as: "survey_result_winner"
});
var SurveyResultWinnerModel_default = SurveyResultWinnerModel;
